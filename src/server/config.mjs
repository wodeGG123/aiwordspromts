...
export function loadConfig(env = process.env) {
  ...
  return Object.freeze({
    ...
    templateRetryLimit: integerEnv(env, "AI_TEMPLATE_RETRY_LIMIT", DEFAULT_LIMITS.templateRetryLimit, { min: 0, max: 3 }),
    upstreamTimeoutMs: integerEnv(env, "AI_TIMEOUT_MS", DEFAULT_LIMITS.upstreamTimeoutMs, { min: 100 }),
